...
class PaginaInicio extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Consumer<PaginaInicioControlador>(builder: (context, controladorPaginaIncio, child) {
      return Scaffold(
        extendBodyBehindAppBar: true,
        appBar: AppBar(
          title: InkWell(
            onTap: () => controladorPaginaIncio.pegarListaDocumentosID(),
        ...
        body: SingleChildScrollView(
          child: ListView.builder(
            shrinkWrap: true,
            itemCount: controladorPaginaIncio.atividades.length,
            itemBuilder: (context, index) {
              final atividade = controladorPaginaIncio.atividades[index];
