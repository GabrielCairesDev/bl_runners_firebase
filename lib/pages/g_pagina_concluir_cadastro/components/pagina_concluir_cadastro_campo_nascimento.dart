...
class PaginaConcluirCampoNascimento extends StatefulWidget {
  ...
  @override
  State<PaginaConcluirCampoNascimento> createState() =>
      _PaginaConcluirCampoNascimentoState();
}

class _PaginaConcluirCampoNascimentoState
    extends State<PaginaConcluirCampoNascimento> {
  @override
    ...
    return TextFormField(
      ...
      onTap: () async {
        ...
        if (pegarData != null) {
          ...
          setState(() {
            widget.controladorConcluirCadastro.dataNascimento =
                pegarHoraTimeStamp;
            widget.controladorConcluirCadastro.controladorNascimento.text =
                dataFormatada;
          });
        }
      },
